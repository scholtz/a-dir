<template>
  <PublicLayout>
    <div class="container-fluid">
      <div class="my-2">
        <h1>Add your internet shop to the directory</h1>
      </div>
      <form @submit="addServiceClick">
        <div class="mb-3">
          <label for="Name" class="form-label">E-Shop Name</label>
          <input
            class="form-control"
            id="Name"
        ...
        <div class="mb-3">
          <label for="URL" class="form-label">E-Shop URL address</label>
          <input
            class="form-control"
            id="URL"
        ...
        <div class="mb-3">
          ...
          <input
            class="form-control"
            id="Tags"
            placeholder="Please provide all tags - basic categories of your products or services you sell, language options, location ..."
            maxlength="200"
            v-model="tags"
          />
        </div>
        ...
        <div class="mb-3">
          <label for="LongDescription" class="form-label"
            >Description - What do you sell, which payment ASAs do you
            accept?</label
          >
        ...
        >
          Improve information about the eshop
        </button>
        <button
          type="submit"
          class="btn btn-primary"
